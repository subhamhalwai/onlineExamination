    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="changePassword.jsp" target="ifra"><span>Change Password</span></a></li>
          <li><a href="exam.jsp" target="ifra"><span>Take Exam</span></a></li> 
          <li><a href="viewResult.jsp" target="ifra"><span>View Result</span></a></li>
